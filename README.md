...
- LLM Wiki：把 RAG evidence 进一步沉淀为 semantic、procedural、lesson、crystal 等知识，再聚合成可搜索的 Wiki 页面。
...
AgentMemory 会把 observation、memory、summary 等 evidence 先提炼为四类知识：
...
然后再把这些知识和 evidence 聚合进固定 Wiki topic：
